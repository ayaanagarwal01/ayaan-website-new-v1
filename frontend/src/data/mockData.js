...
export const servicesData = [
  ...
  },
  {
    id: 5,
    title: 'Debate',
    description: 'From the World Schools Debating League to the Oliphant Memorial Debate, debate has sharpened how I think, argue, and listen.',
    icon: 'mic',
    link: '/debate',
  },
  {
    id: 6,
    title: 'Social Impact',
    description: 'Using storytelling, animation and creative media to raise awareness on causes I care about \u2014 from mental health to inclusivity.',
    icon: 'clapper',
    link: '/social-impact',
  },
];
...
export const socialMediaHandles = [
  ...
  },
  {
    ...
    platform: 'Pinterest',
    handle: '@ayaanagarwal',
    url: 'https://pinterest.com/ayaanagarwal',
    description: 'Curated boards on science, theatre, music inspiration, and creative ideas.',
    isHighlight: false,
    followers: '250+',
  },
  {
    ...
    platform: 'Medium',
    handle: '@ayaanagarwal',
    url: 'https://medium.com/@ayaanagarwal',
    description: 'Long-form articles on research, education, and creative pursuits.',
    isHighlight: false,
    followers: '180+',
  },
  {
    ...
    platform: 'Quora',
    handle: 'Ayaan Agarwal',
    url: 'https://quora.com/profile/Ayaan-Agarwal',
    description: 'Answering questions on science, debate, and student life.',
    isHighlight: false,
    followers: '500+',
  },
  {
