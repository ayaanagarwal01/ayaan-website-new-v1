...
export const researchProjects = [
  {
    ...
    heroText: "Welcome to Ayaan's research portfolio",
    videoId: '598LeXmEWYo',
  ...
  {
    id: 'unified-rna-seq',
    title: 'Unified RNA-seq Meta-analysis Reveals Conserved Metabolic Pathways Underlying Mycobacterium',
...
export const theatreShows = [
  {
    ...
    heroText: "Welcome to Ayaan's Theatre portfolio!",
    gallery: [
