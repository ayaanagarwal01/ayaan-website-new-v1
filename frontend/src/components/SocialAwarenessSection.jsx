...
const SocialAwarenessSection = () => {
  return (
    <section id="social-awareness" className="py-28 bg-[#0a0a1a] relative overflow-hidden z-10">
        ...
        <div className="flex items-end gap-4 mb-16">
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-xs font-semibold text-slate-500 tracking-[0.2em] uppercase">Coming Soon</span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-black text-white tracking-tight">{socialAwarenessData.title}</h2>
          </div>
          <div className="hidden sm:block h-px flex-1 bg-gradient-to-r from-violet-500/15 to-transparent mb-3" />
        </div>

        <div className="grid lg:grid-cols-5 gap-10 lg:gap-16">
          <div className="lg:col-span-3">
            <h3 className="text-2xl font-bold text-white mb-6 tracking-tight">{socialAwarenessData.subtitle}</h3>
            <p className="text-slate-400 text-base leading-[1.8] mb-8">{socialAwarenessData.description}</p>
            <div className="relative p-6 rounded-2xl bg-gradient-to-br from-violet-500/[0.08] to-cyan-500/[0.05] border border-violet-500/15 overflow-hidden">
              ...
              <div className="relative flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed">{socialAwarenessData.comingSoon}</p>
                </div>
              </div>
            </div>
          </div>
